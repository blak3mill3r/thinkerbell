...
void trainefy(DBN &dbn, float learning_rate, float weight_cost, float momentum)
{
  // init scheduler
  DBNScheduler scheduler( &dbn, BATCH_SIZE, NUM_BATCHES_ON_DEVICE, NUM_BATCHES_ON_HOST, prepare_examples, learning_rate, weight_cost, momentum );
...
int main(int argc, char** argv)
{
  ...
  lgo_again:
  trainefy(dbn, learning_rate, WEIGHT_COST, MOMENTUM);
